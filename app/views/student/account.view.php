                ...
                <div class="flex mt-5 gap-5">
                    <form class="flex flex-col w-2/3" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="flex flex-col border-box p-5 pb-10 bg-white shadow rounded-xl mt-5 gap-5">
                            <p class="text-lg font-bold">Student Information</p>
                            <div class="flex justify-evenly w-full">
                                <div class="flex flex-col" style="width: 40%;">
                                    <label for="registration_number" class="text-sm text-gray">Registration
                                        Number</label>
                                    <input type="text" name="registration_number" id="registration_number"
                                        class="border border-primary-color rounded-md p-2 text-gray"
                                        value="<?= $pageData['userData']['registration_number'] ?>" disabled>
                                </div>
                                <div class="flex flex-col" style="width: 40%;">
                                    <label for="index_number" class="text-sm text-gray">Index Number</label>
                                    <input type="text" name="index_number" id="index_number"
                                        class="border border-primary-color rounded-md p-2 text-gray"
                                        value="<?= $pageData['userData']['index_number'] ?>" disabled>
                                </div>
                            </div>
                            <div class="flex justify-evenly w-full mt-5">
                                <div class="flex flex-col" style="width: 40%;">
                                    <label for="course" class="text-sm text-gray">Course</label>
                                    <input type="text" name="course" id="course"
                                        class="border border-primary-color rounded-md p-2 text-gray"
                                        value="<?= $pageData['userData']['course'] ?>" disabled>
                                </div>
                                <div class="flex flex-col" style="width: 40%;">
                                    <label for="year" class="text-sm text-gray">Year</label>
                                    <input type="text" name="year" id="year"
                                        class="border border-primary-color rounded-md p-2 text-gray"
                                        value="<?= $pageData['userData']['year'] ?>" disabled>
                                </div>
                            </div>
                            <div class="flex justify-evenly w-full mt-5">
                                <div class="flex flex-col" style="width: 40%;">
                                    <label for="group" class="text-sm text-gray">Group</label>
                                    <input type="text" name="group" id="group"
                                        class="border border-primary-color rounded-md p-2 text-gray"
                                        value="<?= $pageData['userData']['group_id'] ?>" disabled>
                                </div>
                                <div class="flex flex-col" style="width: 40%;">
                                    <label for="bracket_id" class="text-sm text-gray">Bracket ID</label>
                                    <input type="text" name="bracket_id" id="bracket_id"
                                        class="border border-primary-color rounded-md p-2 text-gray"
                                        value="<?= $pageData['userData']['bracket_id'] ?>" disabled>
                                </div>
                            </div>
                        </div>
                    </form>
