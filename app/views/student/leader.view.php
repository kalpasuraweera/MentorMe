                    ...
                    <div class="flex flex-col bg-white shadow rounded-xl p-5">
                        ...
                        <div class="flex justify-end mt-5 gap-5">
                            <?php if ($requestData['status'] === 'PENDING'): ?>
                                ...
                                <?php $this->renderComponent('button', ['name' => 'cancel_request', 'text' => 'Cancel', 'bg' => 'bg-red']) ?>
                                <!-- Show update form when button is clicked -->
                                <?php $this->renderComponent('button', ['name' => 'update_request', 'text' => 'Update', 'bg' => 'bg-blue']) ?>
