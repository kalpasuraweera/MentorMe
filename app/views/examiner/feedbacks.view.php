        ...
        <form action="" method="post" class="bg-white p-5 rounded-md w-full"
            ...
            <div class="flex flex-col gap-5 my-5">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <textarea name="task" id="task" class="border border-primary-color rounded-xl p-0" required
                        rows="5"></textarea>
                </div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <select name="scope" id="scope" class="border border-primary-color rounded-xl p-2">
                        <option value="USER_<?= $_SESSION['user']['user_id'] ?>">task passed</option>
                        <option value="USER_<?= $_SESSION['user']['user_id'] ?>">task failed</option>
            ...
            <div class="flex flex-col gap-5 my-5">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <textarea name="feedback" id="editFeedbackFeedback"
                        class="border border-primary-color rounded-xl p-2" required rows="5"></textarea>
                </div>
                <div class="flex justify-end gap-5">
                    <button type="button"
                        class="btn-secondary-color rounded-3xl text-center text-white text-base font-medium px-10 py-2"
