        ...
        <div class="flex flex-col w-3/4 px-5 h-screen overflow-y-scroll">
            ...
            <div class="bg-white p-5 rounded-2xl shadow-xl flex-1" style="min-width:200px;">
                ...
                <div class="flex w-full mt-5 mb-5">
                    <?php if ($pageData['codeCheck'][0]['status'] == 0): ?>
                        <button id="" class="bg-blue rounded-lg text-center text-white text-base font-medium px-5 py-4 mx-2"
                            onclick="openStartPopupCodeCheck()">Start Code Check
                        </button>
                    <?php else: ?>
                        <button id="" class="bg-red rounded-lg text-center text-white text-base font-medium px-5 py-4 mx-2"
                            onclick="openEndPopupCodeCheck()">End Code Check
                        </button>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="bg-white p-5 rounded-2xl shadow-xl flex-1 my-5" style="min-width:200px;">
                ...
                <div class="pb-5">
                    ...
                    <div class="flex justify-end w-full mt-4">
                        <button id="CStimeTableCreate"
                            class="bg-blue rounded-lg text-center text-white text-base font-medium px-5 py-2 mx-2"
                            onclick="openImportPopup()">Import CS Time Table
                        </button>
                        <button id="CStimeTableDelete"
                            class="bg-red rounded-lg text-center text-white text-base font-medium px-5 py-2"
                            onclick="openDeleteTimetablePopup()">Delete CS Time Table
                        </button>
                    </div>
                    ...
                    <div class="flex justify-end w-full">
                        <button id="IStimeTableCreate"
                            class="bg-blue rounded-lg text-center text-white text-base font-medium px-5 py-2 mx-2"
                            onclick="openImportPopup()">Import IS Time Table
                        </button>
                        <button id="IStimeTableDelete"
                            class="bg-red rounded-lg text-center text-white text-base font-medium px-5 py-2"
                            onclick="openDeleteTimetablePopup()">Delete IS Time Table
                        </button>
                    </div>
                </div>
                ...
                <div class="w-full flex justify-evenly text-center bg-gray py-2 rounded-lg">
                    ...
                    <button onclick="openTab('IS')" class="flex-1 mx-2 px-4 py-2 font-medium rounded-lg" id="ISBtn">
                        Information System
                    </button>
                </div>
