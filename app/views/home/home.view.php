...
<body class="bg-primary-color">
    ...
    <div class="flex flex-col px-2 py-2 items-center">
        <!-- Navbar -->
        <div class="rounded-lg bg-white flex w-full py-2 px-2 mx-4 my-4 justify-between" style="max-width: 90vw;">
            ...
            <div class="flex flex-row items-center gap-4">
                ...
                <a href="<?= BASE_URL ?>/auth/login"
                    class="btn-primary-color rounded-3xl text-center text-white text-base font-medium px-10 py-2">Login</a>
            </div>
        </div>
        <!-- Hero Section -->
        <div class="flex flex-col items-center justify-center w-full" style="height: 80vh;">
            <div class="flex flex-col items-center w-1/2 text-center">
                <p class="text-black text-6xl font-bold">Welcome to MentorMe</p>
                <p class="text-black text-2xl font-medium">A platform to connect mentors and mentees</p>
                <a href="<?= BASE_URL ?>/auth/register"
                    class="btn-primary-color rounded-3xl text-center text-white text-base font-medium px-10 py-2 mt-4">Get
                    Started</a>
            </div>
        </div>
    </div>
