        ...
        <div class="flex flex-col px-5">
            ...
            <form class="px-10 py-10 bg-white rounded-2xl flex-col justify-start items-start">
                <div class="flex flex-col mt-5">
                    ...
                    <input
                        class="px-4 py-2 bg-white rounded-lg border border-primary justify-start items-center inline-flex"
                ...
                <div class="flex justify-end">
                    <button
                        class="btn-bg-primary rounded-3xl text-center text-white text-base font-medium px-10 py-2">Login</button>
                </div>
            </form>
        </div>
        <div class="">
